...
<section id="about">
	<article>                   
		...
		<p>
			TED’s media initiatives include <a href="http://www.ted.com" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://www.ted.com']);">TED.com</a>, where new TEDTalks are posted daily; the new TED Conversations, enabling broad conversations among TED fans; and the Open Translation Project, which provides subtitles and interactive transcripts as well as the ability for any TEDTalk to be translated by volunteers worldwide.
		</p>
		<p>
        	TED has established the annual TED Prize, where exceptional individuals with a wish to change the world are given the opportunity to put their wishes into action; TEDx, which offers individuals or groups a way to host local, self-organized events around the world; and the TED Fellows program, helping world-changing innovators from around the globe to become part of the TED community and, with its help, amplify the impact of their remarkable projects and activities.
        </p>
		<p>
        	For information about TED’s upcoming conferences, visit <a href="http://www.ted.com/registration" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://www.ted.com']);">http://www.ted.com/registration</a>.
        </p>
		<p>
        	Follow TED on <a href="http://twitter.com/TEDTalks" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://twitter.com']);">Twitter</a> or on <a href="http://www.facebook.com/TED" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://www.facebook.com']);">Facebook</a>.
        </p>
