        ...
        <section id="bk_account">
            <article>
                ...
                <ul>
                    <!-- do a loop on li-->
                    <li>
                        {$person_name}{$person_firstName} <!-- ATTENTION ajouter boutton modifier /!\ modifier renvoit au champ infos du comptes selectionné sur la meme page!(section ci-dessous) et supprimer-->
                    </li>
                </ul>
